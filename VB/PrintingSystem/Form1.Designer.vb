...
'ORIGINAL LINE: this.btn_PrintFromServer.Click += new System.EventHandler(this.btn_PrintFromServer_Click);
			' 
			' Form1
			' 
		...
		Private WithEvents btn_PrintFromServer As System.Windows.Forms.Button
	End Class
End Namespace
